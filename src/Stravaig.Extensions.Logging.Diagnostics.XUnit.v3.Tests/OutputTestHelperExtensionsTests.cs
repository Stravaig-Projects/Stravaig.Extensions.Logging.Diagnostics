...
public class OutputTestHelperExtensionTests
{
    ...
    public void RenderedLogEntryMessagesSentToOutputTestHelper()
    {
        ...
        outputHelper.Messages[0].ShouldBe("[0 Information Stravaig.Extensions.Logging.Diagnostics.XUnit.v3.Tests.OutputTestHelperExtensionTests] This is an information Message.");
        outputHelper.Messages[1].ShouldBe("[1 Information Stravaig.Extensions.Logging.Diagnostics.XUnit.v3.Tests.OutputTestHelperExtensionTests] This is a Warning Message.");
    }
